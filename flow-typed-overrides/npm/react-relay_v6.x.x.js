...
declare module "react-relay" {
  ...
  declare export type NormalizationArgumentDefinition =
  ...
  declare export type NormalizationRootArgument = {|
    +kind: 'RootArgument',
    +name: string,
    +type: ?string,
  |};
  ...
  declare export type NormalizationLocalArgument = {|
    +kind: 'LocalArgument',
    +name: string,
    +type: string,
    +defaultValue: mixed,
  ...
  declare export type ReaderSplitOperation = {
    +kind: 'SplitOperation',
    +name: string,
    +metadata: ?{+[key: string]: mixed},
    +selections: $ReadOnlyArray<ReaderSelection>,
  ...
  declare export type ReaderSelectableNode = ReaderFragment | ReaderSplitOperation;

  // The type of a graphql`...` tagged template expression.
  declare export type GraphQLTaggedNode<V, R> =
    | ReaderFragment
    | ConcreteRequest
  ...
  declare export type GraphQLQuery<
    QueryT: {variables: *, response: *}
  > = GraphQLTaggedNode<
    $PropertyType<QueryT, "variables">,
    $PropertyType<QueryT, "response">
  >;

  declare export function graphql(
    strings: Array<string>
  ): GraphQLTaggedNode<any, any>;

  declare export type GeneratedNodeMap = {
    [key: string]: GraphQLTaggedNode<any, any>,
  };

  declare type FragmentifyProps<Props: {}> = $ObjMap<
    Props,
    (<V, T: {+$refType: V}>(T) => {+$fragmentRefs: V}) &
      (<V, T: ?{+$refType: V}>(T) => ?{+$fragmentRefs: V}) &
      (<V, T: $ReadOnlyArray<{+$refType: V}>>(T) => $ReadOnlyArray<{+$fragmentRefs: V}>) &
      (<V, T: ?$ReadOnlyArray<{+$refType: V}>>(T) => ?$ReadOnlyArray<{+$fragmentRefs: V}>) &
      (<T>(T) => T)
  >;

  declare export type ApplyFragmentsToProps<T> = $Call<
    <PropsT: {}, ComponentT: React$ComponentType<PropsT>>(
      ComponentT
    ) => React$ComponentType<FragmentifyProps<React$ElementConfig<ComponentT>>>,
    T
  >;

  declare type WithoutRelay<Props: {}, R> = $Diff<Props, {+relay: R | void}>;

  declare type RemoveRelayProp<R, T> = $Call<
    <P, ComponentT: React$ComponentType<P>>(
      ComponentT
    ) => React$ComponentType<WithoutRelay<React$ElementConfig<ComponentT>, R>>,
    T
  >;
  ...
  > = {
    ...
    getConnectionFromProps?: (props: Props) => ?ConnectionData,
    getFragmentVariables?: (
      prevVars: $ReadOnly<PaginationVariables>,
      totalCount: number
    ) => RenderVariables,
    getVariables: (
      props: Props,
      paginationInfo: {count: number, cursor: ?string},
      fragmentVariables: RenderVariables
    ) => PaginationVariables,
    query: GraphQLTaggedNode<any, any>,
  };
  ...
  declare type TGraphQLTaggedNode = GraphQLTaggedNode<any, any>;
  ...
  // Flow doesn't allow for recursive ObjMap calls (it bottoms out when encountering a second instance of the same ObjMap)
  // As a workaround we simply duplicate the same type. If you end up with an object that is deeper than these levels just
  // add a few more.
  declare type RecursiveReadOnly5<T> = $ReadOnly<
    $ObjMap<
      T,
      (<V: {}>(V) => RecursiveReadOnly<V>) &
        (<E: {}, V: Array<E>>(V) => $ReadOnlyArray<RecursiveReadOnly<E>>) &
        (<E, V: Array<E>>(V) => $ReadOnlyArray<E>) &
        (<E: {}, V: $ReadOnlyArray<E>>(
          V
        ) => $ReadOnlyArray<RecursiveReadOnly<E>>) &
        (<E, V: $ReadOnlyArray<E>>(V) => $ReadOnlyArray<E>) &
        (<V>(V) => V)
    >
  >;
  declare type RecursiveReadOnly4<T> = $ReadOnly<
    $ObjMap<
      T,
      (<V: {}>(V) => RecursiveReadOnly5<V>) &
        (<E: {}, V: Array<E>>(V) => $ReadOnlyArray<RecursiveReadOnly5<E>>) &
        (<E, V: Array<E>>(V) => $ReadOnlyArray<E>) &
        (<E: {}, V: $ReadOnlyArray<E>>(
          V
        ) => $ReadOnlyArray<RecursiveReadOnly5<E>>) &
        (<E, V: $ReadOnlyArray<E>>(V) => $ReadOnlyArray<E>) &
        (<V>(V) => V)
    >
  >;
  declare type RecursiveReadOnly3<T> = $ReadOnly<
    $ObjMap<
      T,
      (<V: {}>(V) => RecursiveReadOnly4<V>) &
        (<E: {}, V: Array<E>>(V) => $ReadOnlyArray<RecursiveReadOnly4<E>>) &
        (<E, V: Array<E>>(V) => $ReadOnlyArray<E>) &
        (<E: {}, V: $ReadOnlyArray<E>>(
          V
        ) => $ReadOnlyArray<RecursiveReadOnly4<E>>) &
        (<E, V: $ReadOnlyArray<E>>(V) => $ReadOnlyArray<E>) &
        (<V>(V) => V)
    >
  >;
  declare type RecursiveReadOnly2<T> = $ReadOnly<
    $ObjMap<
      T,
      (<V: {}>(V) => RecursiveReadOnly3<V>) &
        (<E: {}, V: Array<E>>(V) => $ReadOnlyArray<RecursiveReadOnly3<E>>) &
        (<E, V: Array<E>>(V) => $ReadOnlyArray<E>) &
        (<E: {}, V: $ReadOnlyArray<E>>(
          V
        ) => $ReadOnlyArray<RecursiveReadOnly3<E>>) &
        (<E, V: $ReadOnlyArray<E>>(V) => $ReadOnlyArray<E>) &
        (<V>(V) => V)
    >
  >;
  declare type RecursiveReadOnly<T> = $ReadOnly<
    $ObjMap<
      T,
      (<V: {}>(V) => RecursiveReadOnly2<V>) &
        (<E: {}, V: Array<E>>(V) => $ReadOnlyArray<RecursiveReadOnly2<E>>) &
        (<E, V: Array<E>>(V) => $ReadOnlyArray<E>) &
        (<E: {}, V: $ReadOnlyArray<E>>(
          V
        ) => $ReadOnlyArray<RecursiveReadOnly2<E>>) &
        (<E, V: $ReadOnlyArray<E>>(V) => $ReadOnlyArray<E>) &
        (<V>(V) => V)
    >
  >;

  declare export type MutationConfig<QueryT> = {|
    configs?: Array<RelayMutationConfig>,
    mutation: GraphQLQuery<QueryT>,
    variables: RecursiveReadOnly<$PropertyType<QueryT, "variables">>,
    uploadables?: UploadableMap,
    onCompleted?: ?(
      response: ?$PropertyType<QueryT, "response">,
      errors: ?Array<PayloadError>
    ) => void,
    onError?: ?(error: Error) => void,
    ...
    updater?: ?(
      ...
      data: $PropertyType<QueryT, "response">,
    ) => void,
  |};
  ...
  declare export type ReadyState<R: {}> = {
    error: ?Error,
    props: ?R,
    retry: ?() => void,
  };
  ...
  declare export type QueryRendererProps<QueryT> = {|
    +cacheConfig?: ?CacheConfig,
    +fetchPolicy?: "store-and-network" | "network-only",
    +environment: Environment | ClassicEnvironment,
    +query: GraphQLQuery<QueryT>,
    +render: (
      readyState: ReadyState<$PropertyType<QueryT, "response">>
    ) => ?React.Node,
    +variables?: RecursiveReadOnly<$PropertyType<QueryT, "variables">>,
  |};

  declare export class QueryRenderer<QueryT> extends React$Component<QueryRendererProps<QueryT>> {}
  ...
  declare export type RelayPaginationProp<V> = {|
    ...RelayProp,
    hasMore: () => boolean,
    isLoading: () => boolean,
    loadMore: (
      ...
      options?: $ReadOnly<RefetchOptions>
    ) => ?Disposable,
    refetchConnection: (
      totalCount: number,
      callback: (error: ?Error) => void,
      refetchVariables: ?$ReadOnly<V>
    ) => ?Disposable,
  |};

  declare export type RelayPaginationPropWithUntypedParameters = RelayPaginationProp<
    Variables
  >;

  declare export type RelayRefetchProp<V> = {|
    ...RelayProp,
    refetch: (
      refetchVariables: | RecursiveReadOnly<V>
      | ((fragmentVariables: V) => RecursiveReadOnly<V>),
      renderVariables: ?RecursiveReadOnly<V>,
      callback: ?(error: ?Error) => void,
      options?: $ReadOnly<RefetchOptions>
    ) => Disposable,
  |};

  declare export type RelayRefetchPropWithUntypedParameters = RelayRefetchProp<
    Variables
  >;
  ...
  declare export function createRefetchContainer<
    QueryT,
    T: {+relay: RelayRefetchProp<$PropertyType<QueryT, "variables">>},
    TBase: React$ComponentType<T>
  >(
    Component: TBase,
    fragmentSpec: GeneratedNodeMap,
    refetchQuery: GraphQLQuery<QueryT>
  ): React$ComponentType<
    FragmentifyProps<
      WithoutRelay<React$ElementConfig<TBase>, $PropertyType<T, "relay">>
    >
  >;
  ...
  declare export function createPaginationContainer<
    PaginationVariables,
    RenderVariables,
    T: {+relay: RelayPaginationProp<PaginationVariables>},
    TBase: React$ComponentType<T>
  >(
    Component: TBase,
    fragmentSpec: GeneratedNodeMap,
    connectionConfig: $ReadOnly<
      ConnectionConfig<$ReadOnly<T>, PaginationVariables, RenderVariables>
    >
  ): React$ComponentType<
    FragmentifyProps<
      WithoutRelay<React$ElementConfig<TBase>, $PropertyType<T, "relay">>
  ...
  declare export function fetchQuery<QueryT>(
    environment: Environment | ClassicEnvironment,
    query: GraphQLQuery<QueryT>,
    variables: ?$ReadOnly<$PropertyType<QueryT, "variables">>
  ): Promise<$PropertyType<QueryT, "response">>;

  declare export function createFragmentContainer<
    PropsT: {},
    TBase: React$ComponentType<PropsT>
  >(
    Component: TBase,
    fragmentSpec: GeneratedNodeMap
  ): React$ComponentType<
    FragmentifyProps<
      WithoutRelay<React$ElementConfig<TBase>, {+environment: Environment}>
    >
  >;
}
