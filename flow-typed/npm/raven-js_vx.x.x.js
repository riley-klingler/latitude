...
// https://github.com/flowtype/flow-typed/blob/5b150db5b64aa0ab54104ef924aa31a6cceead6d/definitions/npm/raven-js_v3.17.x/flow_v0.38.x-/raven-js_v3.17.x.js

type LogLevel = "critical" | "error" | "warning" | "info" | "debug";

type DataValue = number | string | boolean | null | void;
...
declare module "raven-js" {
  declare export type RavenOptions = {
  ...
  declare class Raven {
    ...
    config(dsn: string, options?: any): this;
    ...
    setUserContext(user: mixed): this;
